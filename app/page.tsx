					...
					<div className="container px-4 md:px-6 relative">
						...
						>
							...
							<h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70">
								Elevate Your Workflow with Dental Offices Bot
							</h1>
						...
						>
							<div className="rounded-xl overflow-hidden shadow-2xl border border-border/40 bg-gradient-to-b from-background to-muted/20">
								<Image
									...
									width={1280}
									height={720}
									alt="Dental Offices Bot dashboard"
					...
					<div className="container px-4 md:px-6">
						...
						<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
							{[
								{
									quote:
										"Dental Offices Bot has transformed how we manage our projects. The automation features have saved us countless hours of manual work.",
								...
								{
									quote:
										"We've tried several similar solutions, but none compare to the ease of use and comprehensive features of Dental Offices Bot. It's been a game-changer.",
									author: "David Kim",
								...
								{
									quote:
										"Implementation was seamless, and the ROI was almost immediate. We've reduced our operational costs by 30% since switching to Dental Offices Bot.",
									author: "James Wilson",
				...
				<div className="container flex flex-col gap-8 px-4 py-10 md:px-6 lg:py-16">
					...
					<div className="flex flex-col gap-4 sm:flex-row justify-between items-center border-t border-border/40 pt-8">
						<p className="text-xs text-muted-foreground">
							&copy; {new Date().getFullYear()} Dental Offices Bot. All rights
							reserved.
						</p>
						<div className="flex gap-4">
							<Link
